...
const RestaurantCard=({resName,cuisine})=>{
    return(
        <div className='res-card'>
            <img className='card-img' src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/nv9q1gsfyzezfb4sndc7" alt="" />
            <h3>{resName}</h3>
            <h3>{cuisine}</h3>
            <h4>4.4 stars</h4>
        </div>
